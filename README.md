...
- Backend: Spring Boot for processing YAML files and generating code.
- Database: H2 (in memory) for temporary storage of configurations.
- RESTful API: Communication between the frontend and the backend.
